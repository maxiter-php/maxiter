...
<link rel='stylesheet' href='<?= EnvModel::env('APP_BASE_URL') ?>resources/views/pages/home/css/home.css'>
...
<section class="section bg-secondary position-relative">
  <div class="bg-image overlay-secondary">
    <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/feature.jpg" alt="bg-image">
  </div>
    ...
    <div class="row">
      <div class="col-xl-9 mx-auto">
        <div class="row align-items-center">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/feature.jpg" alt="feature-image" class="img-fluid">
          </div>
    ...
    <div class="row no-gutters">
      <div class="col-lg-3 col-sm-6">
        <div class="card hover-shadow">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/team/member-1.jpg" alt="team-member" class="card-img-top">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="card hover-shadow">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/team/member-2.jpg" alt="team-member" class="card-img-top">
          <div class="card-body text-center position-relative zindex-1">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="card hover-shadow">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/team/member-3.jpg" alt="team-member" class="card-img-top">
          <div class="card-body text-center position-relative zindex-1">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="card hover-shadow">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/team/member-4.jpg" alt="team-member" class="card-img-top">
          <div class="card-body text-center">
            <h4>Devid Json</h4>
            <i>CEO</i>
          </div>
...
<section class="section-lg position-relative bg-cover" data-background="images/backgrounds/about-bg.jpg">
  <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/backgrounds/about-bg-overlay.png" alt="overlay" class="overlay-image img-fluid">
  <div class="container">
    ...
    <div class="row no-gutters shuffle-wrapper">
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/project/project-1.jpg" alt="project-image" class="img-fluid w-100">
      ...
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/project/project-2.jpg" alt="project-image" class="img-fluid w-100">
          <div class="project-hover bg-secondary px-4 py-3">
            <a href="#" class="text-white h4">Project title</a>
            <a href="#"><i class="ti-link icon-xs text-white"></i></a>
          </div>
      ...
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/project/project-3.jpg" alt="project-image" class="img-fluid w-100">
          <div class="project-hover bg-secondary px-4 py-3">
            <a href="#" class="text-white h4">Project title</a>
            <a href="#"><i class="ti-link icon-xs text-white"></i></a>
          </div>
      ...
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/project/project-4.jpg" alt="project-image" class="img-fluid w-100">
          <div class="project-hover bg-secondary px-4 py-3">
            <a href="#" class="text-white h4">Project title</a>
            <a href="#"><i class="ti-link icon-xs text-white"></i></a>
          </div>
      ...
      <div class="col-lg-4 col-md-6 shuffle-item">
        <div class="project-item">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/project/project-5.jpg" alt="project-image" class="img-fluid w-100">
          <div class="project-hover bg-secondary px-4 py-3">
            <a href="#" class="text-white h4">Project title</a>
            <a href="#"><i class="ti-link icon-xs text-white"></i></a>
          </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
        <article class="card">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/blog/post-1.jpg" alt="post-thumb" class="card-img-top mb-2">
      ...
      <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
        <article class="card">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/blog/post-2.jpg" alt="post-thumb" class="card-img-top mb-2">
          <div class="card-body p-0">
            <time>January 15, 2018</time>
            <a href="blog-single" class="h4 card-title d-block my-3 text-dark hover-text-underline">How These Different
              Book Covers Reflect the Design</a>
      ...
      <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
        <article class="card">
          <img src="<?= EnvModel::env('APP_BASE_URL') ?>resources/views/images/blog/post-3.jpg" alt="post-thumb" class="card-img-top mb-2">
          <div class="card-body p-0">
            <time>January 15, 2018</time>
            <a href="blog-single" class="h4 card-title d-block my-3 text-dark hover-text-underline">How These Different
              Book Covers Reflect the Design</a>
...
<!-- /blog -->
<script src='<?= EnvModel::env('APP_BASE_URL') ?>resources/views/pages/home/js/home.js'></script>
