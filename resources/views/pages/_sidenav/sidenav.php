...
<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="<?= EnvModel::env("APP_BASE_URL") ?>home" aria-expanded="false"><i class="icon icon-globe-2"></i><span
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                ...
                <ul aria-expanded="false">
                    <li><a href="<?= EnvModel::env("APP_BASE_URL") ?>list-example">List Example</a></li>
                </ul>
            </li>
